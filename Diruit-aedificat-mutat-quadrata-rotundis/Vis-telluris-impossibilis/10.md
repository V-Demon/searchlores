Merci ! Nous arrivons maintenant au chapitre que j'appelle **le point de bascule**.

Jusqu'ici, nous avons étudié les briques du framework de manière relativement isolée :
...
> **Comment toutes ces pièces collaborent-elles lorsqu'une véritable investigation démarre ?**

C'est précisément ce que nous allons reconstruire.

À mon sens, c'est le chapitre le plus important depuis le début de cette monographie.
